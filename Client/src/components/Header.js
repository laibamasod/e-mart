...
const Header = () => {
  return (
    ...
    <div className="container-fluid px-5 py-2 d-flex align-items-center justify-content-between">
      <div>
       <a href="#" className="upper-head mx-2" > <span >Become a Seller</span> </a>
       <a href="#" className="upper-head mx-2" > <span>Help & Support</span></a>
       <a href="#" className="upper-head mx-2" > <span>Daraz Affiliate Program</span></a>
      </div>
      <div>
        <img className="hoverable-text small-logo" src={logo1} alt="Darazlogo" />
        ...
        <form className="form-inline my-2 my-lg-0 flex-grow-1 d-flex justify-content-center">
          <div className="input-group flex-grow-1">
            ...
            <div className="input-group-append">
              <button className="btn btn-light btn-outline-light px-3" type="submit">
                <FontAwesomeIcon icon={faSearch} style={{ color: 'orange' }}/>
              </button>
            </div>
          </div>
        </form>
